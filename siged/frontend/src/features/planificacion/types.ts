...
export interface Grade { id: number; nombre: string; orden: number; nivel: LevelSummary; subnivel: LevelSummary | null; carga_pedagogica_actual: number; carga_pedagogica_minima: number; alerta_carga_pedagogica: boolean }
