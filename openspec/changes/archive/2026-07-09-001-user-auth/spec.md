...
- THEN the response is HTTP 400 with a message indicating invalid credentials
...
- WHEN the user submits `POST /api/login/` with those credentials
- THEN the response is HTTP 400 with a message indicating the account is inactive
...
| RF-002 | `core/servicios/autenticacion_servicio.py`, `core/daos/usuario_dao.py`, `core/apis/views.py` | `features/auth/services/authApi.ts`, `features/auth/context/AuthContext.tsx` | `core/tests.py::LoginExitoTest`, `features/auth/context/__tests__/AuthContext.test.tsx` |
...
| RF-005 | `core/apis/views.py::LogoutView`, `core/servicios/autenticacion_servicio.py` | `features/auth/services/authApi.ts`, `features/auth/context/AuthContext.tsx`, `features/layout/components/TopBar.tsx` | `core/tests.py::LogoutExitoTest`, `features/auth/services/__tests__/authApi.test.ts` |
